...
const messages = {
  en: {
    ...
    dnp: {
      title: 'About DNP',
      text: ['Dai Nippon Printing (DNP) was established in as far back as 1876', 'Today, the DNP Group is one of the largest diversified printing/coating technology companies in the world, with approximately 40,000 employees worldwide.', ' DNP has been the pioneer of dye sublimating printing technology and is the world’s largest manufacturer of dye sublimation ribbons.']      
  ...
  srb: {
    ...
    dnp: {
      title: "O DNP",
      text: ['Dai Nippon Printing (DNP) je osnovan 1876. godine.', 'Danas, DNP je jedna od najvećih svetskih kompanija koja se bavi tehnologijama štampe, sa približno 40.000 zaposlenih širom sveta.', 'DNP je pionir tehnologije štampanja fotografija sublimacionom metodom i najveći je svetski proizvođač sublimacionih traka.', ]
      },
