<template>
  <div>
    <div  :class="$vuetify.breakpoint.smAndUp ? 'wrapper' : ''">
      <h2 class="my-3 red--text text-center" style="font-size: 3em">{{$t('printers.list[1].title')}}</h2>
      <v-row justify="center" class="my-5 mx-3">
        <v-col cols="12" md="6">
          ...
          >
            ...
            >
              <v-img
                contain
                :src="require(`@/assets/DS820/${i}.jpg`)"
              ></v-img>
            </v-carousel-item>
          </v-carousel>
        </v-col>
        <v-col cols="12" md="6">
          ...
          <div class="mt-10">
            <h3 class="my-3">{{$i18n.locale == 'srb' ? '8-INČA FOTO ŠTAMPAČ' : "8-INCH FOTO PRINT"}}</h3>
