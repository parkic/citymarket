<template>
  <div>
    <div  :class="$vuetify.breakpoint.smAndUp ? 'wrapper' : ''">
      <h2 class="my-3 red--text text-center" style="font-size: 3em">{{$t('printers.list[2].title')}}</h2>
      <v-row justify="center" class="my-5 mx-3">
        <v-col cols="12" md="6">
          <v-carousel
            :height="$vuetify.breakpoint.lgAndUp ? '500px' : '300px'"
            :hide-delimiters="$vuetify.breakpoint.lgAndUp"
          >
            <v-carousel-item
              v-for="i in 6"
              :key="i"
            ...
            >
              <v-img
                contain
                :src="require(`@/assets/RX1HS/${i}.jpg`)"
              ></v-img>
            </v-carousel-item>
          </v-carousel>
        </v-col>
        <v-col cols="12" md="6">
          ...
          <div class="mt-10">
            ...
            <p><b>Reference:</b> {{$t('printers.list[2].reference')}}</p>
            <p><b>Condition:</b> {{$t('printers.list[2].condition')}}</p>
...
<script>
import ThePrednosti from "@/components/RX1HS/ThePrednosti.vue"
import TheSpecifikacije from "@/components/RX1HS/TheSpecifikacije.vue"
